...
void HariMain(void)
{
	...
	putfonts8_asc(binfo->vram, binfo->scrnx, 80, 80, COL8_000000, "Effective Font Test.");
	putfonts8_asc(binfo->vram, binfo->scrnx, 79, 79, COL8_C6C6C6, "Effective Font Test.");
	putfonts8_asc(binfo->vram, binfo->scrnx, 78, 78, COL8_FFFFFF, "Effective Font Test.");
